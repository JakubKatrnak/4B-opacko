...
-- Generation Time: Nov 29, 2021 at 06:27 PM
...
--
-- Table structure for table `pocet_prijatych`
--
...
--
-- Dumping data for table `pocet_prijatych`
--
...
(1, '127.0.0.1', 'administrator', '$2y$12$mTreyJfufZmFnJpI3XFdoeXq04jolCXhpOoXqt6DpxyzDfghSVUtC', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1637650614, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
-- Table structure for table `zpetna_vazba`
--
...
--
-- Indexes for table `pocet_prijatych`
--
...
--
-- Indexes for table `zpetna_vazba`
--
...
--
-- AUTO_INCREMENT for table `pocet_prijatych`
--
ALTER TABLE `pocet_prijatych`
...
--
-- AUTO_INCREMENT for table `zpetna_vazba`
--
ALTER TABLE `zpetna_vazba`
